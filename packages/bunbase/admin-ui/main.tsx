...
function ThemeProvider({ children }: { children: React.ReactNode }) {
  const [theme, setThemeState] = useState<Theme>(() => {
    return (localStorage.getItem("bunbase-admin-theme") as Theme) || "system";
  });
  ...
  const setTheme = (t: Theme) => {
    localStorage.setItem("bunbase-admin-theme", t);
    setThemeState(t);
  };
...
const SECTION_DESCRIPTIONS: Record<NavSection, string> = {
  ...
  settings: "Read-only BunBase instance configuration.",
};
