...
The [`examples/task-manager`](https://github.com/NatiCha/bunbase/tree/main/examples/task-manager) directory is a full running app demonstrating:
...
See [`docs/examples.ts`](https://github.com/NatiCha/bunbase/blob/main/packages/bunbase/docs/examples.ts) for compile-checked code snippets covering every pattern: filters, pagination, expand, rules, hooks, jobs, OAuth, and more.
