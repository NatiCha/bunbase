...
BunBase provides file upload, download, and deletion tied to collection records. Files are stored locally or on S3 and tracked in an internal `_files` table.
